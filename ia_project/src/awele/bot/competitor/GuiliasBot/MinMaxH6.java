...
public class MinMaxH6 extends CompetitorBot {
    ...
    public double[] getDecision(Board board) {
        ...
        for (int depth = 1; depth <= 50; depth++) {
            ...
            // On initialise Alpha et Beta à la racine
            ...
            for (int holeIndex = 0; holeIndex < 6; holeIndex++) {
                ...
                if (fastRoot.isValidMove(currentPlayer, i)) {
                    ...
                    double val = minimax(nextState, depth - 1, alpha, beta, false, currentPlayer, startTime);
                    ...
                    alpha = Math.max(alpha, val); // Élagage à la racine !
                }
            }
